...
public class RecognitionControlCamara implements TextureView.SurfaceTextureListener{
    ...
    public RecognitionControlCamara(SpeechManager speechManager, MediaManager mediaManager, TextureView tvMedia){
    ...
    */
    public void startRecognition(String task, String method){
        ...
        // PASAR FRAMES DEL VIDEO A LA API
    ...
    public void sendImageToServerModels(String base64Image, String task, String method) {
        try {
            ...
            // URL de destino
            URL url = new URL("http://192.168.50.177:8080/sendImage?task="+task+"&method="+method+"&mode=text");
